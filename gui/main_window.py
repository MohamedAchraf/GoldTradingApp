...
from PyQt5.QtWidgets import (
    QMainWindow, QTabWidget, QWidget, QVBoxLayout, QHBoxLayout, QGroupBox, QLabel,
    QRadioButton, QCheckBox, QPushButton, QTextEdit, QProgressBar, QSpinBox, QSlider, 
...
# Add the project root directory to the Python path for absolute imports
...
from src.preprocessing import preprocess_data  # Add this line to import preprocess_data
from train_worker import TrainWorker  # Adjust if needed
